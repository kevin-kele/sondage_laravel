        ...
        <form class="needs-validation mx-auto" action="{{route('store.questionaire')}}" method="POST" novalidate>
            ...
            <div class="form-row" style="display: flex;flex-direction: column;justify-content: center;margin: auto;align-items: center;">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="utilisations" onclick="texte11.innerHTML=this.value" id="utilisations1" value="regarder des émissions TV en direct" required>
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="number" class="form-control" min="1" max="5" id="validationCustom01" onkeyup="texte12.innerHTML=this.value" name="qualite" placeholder="Combien donnez vous de point pour la qualité de l’image" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="number" class="form-control" min="1" max="5" id="validationCustom01" onkeyup="texte15.innerHTML=this.value" name="qualite_graph" placeholder="Combien donnez vous de point pour la qualité des graphismes 3D" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="number" class="form-control" min="1" max="5" id="validationCustom01" onkeyup="texte16.innerHTML=this.value" name="qualiteAudio" placeholder="Combien donnez vous de point pour la qualité audio" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="number" class="form-control" min="1" max="5" onkeyup="texte20.innerHTML=this.value" id="validationCustom01" name="jeux_exclusifs" placeholder="Aimeriez vous jouer à des jeux exclusifs" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
